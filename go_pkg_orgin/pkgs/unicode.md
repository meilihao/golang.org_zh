...
<pre>var (
    ...
    <span id="Lt">Lt</span>     = _Lt <span class="comment">// Lt is the set of Unicode characters in category Lt (Letter, titlecase).</span>
...
## <a id="IsPrint">func</a> [IsPrint](https://golang.org/src/unicode/graphic.go?s=1916:1941#L40)
